...
public class UiActor : MB_UiActor<GameManager>
{
    ...
    private void Update()
    {
        scoreText.text = Collect.Instance.collectScore.ToString();
    }
    ...
    private void BtnClick_Play()
    {
        ...
        Move.Instance.levelStart = true;
        Move.Instance.levelFinish = false;
        Move.Instance.levelFailed = false;
        Collect.Instance.canCameraChange = false;
        Collect.Instance.canMoneyCreate = false;
        Collect.Instance.packagedNutCount = 0;
        Collect.Instance.levelEndMoneyMountain = 0;
        Collect.Instance.collectScore = 0;
        ...
        cam2.transform.position = cam2Transform.position;
